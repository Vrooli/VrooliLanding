    ...
    const slides = [
        ...
        },
        {
            ...
            body: [
                ...
                {
                    buttons: [{ text: 'Get Started', position: 'center', color: 'secondary', link: `${APP_URL}${APP_LINKS.Start}` }]
                }
            ]
        },
        {
        ...
        },
        {
            ...
            body: [
                ...
                {
                    buttons: [
                        { text: 'Start Now', position: 'center', color: 'secondary', link: `${APP_URL}${APP_LINKS.Start}` },
